...
class AppConstant {
    ...
    /** 版本号 */
    def static final VER = "2.3.4.4"

    /** 打印信息时候的前缀 */
    def static final TAG = "< amyplugin-plugin-v${VER} >"

    /** 外部用户配置信息 */
    def static final USER_CONFIG = "amypluginPluginConfig"

    /** 用户Task组 */
    def static final TASKS_GROUP = "amyplugin-plugin"
...
apply plugin: 'amyplugin-plugin-gradle\'
amypluginPluginConfig {
    pluginName = "demo3"
    hostApplicationId = "com.amy.replugin.sample.host"
    hostAppLauncherActivity = "com.amy.replugin.sample.host.MainActivity"
}
'''
