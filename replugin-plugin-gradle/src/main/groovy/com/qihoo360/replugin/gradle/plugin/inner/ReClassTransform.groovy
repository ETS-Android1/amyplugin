...
public class ReClassTransform extends Transform {
    ...
    void transform(Context context,
        ...
        /* 读取用户配置 */
        def config = project.extensions.getByName('amypluginPluginConfig')
...
//        println ">>> 拷贝目录 ${input.file.absolutePath} 到 ${dest.absolutePath}"
    ...
    def welcome() {
        println '\n'
        60.times { print '=' }
        println '\n                    amyplugin-plugin-gradle'
        60.times { print '=' }
        println("""
Add amypluginPluginConfig to your build.gradle to enable this plugin:
